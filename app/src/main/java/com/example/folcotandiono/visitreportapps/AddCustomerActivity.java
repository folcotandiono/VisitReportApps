                    ...
                    if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                        ...
                        if (photoFile != null) {
                            Uri photoURI = FileProvider.getUriForFile(AddCustomerActivity.this,
                                    "com.example.folcotandiono.visitreportapps.android.fileprovider",
                                    photoFile);
        ...
        if (item.getItemId() == R.id.addCustomerAdd) {
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    ...
                    Toast.makeText(AddCustomerActivity.this, exception.getMessage(), Toast.LENGTH_SHORT).show();
                }
...
//        Toast.makeText(this, String.valueOf(BitmapCompat.getAllocationByteCount(bitmap)), Toast.LENGTH_SHORT).show();
        ...
        addCustomerPhoto.setLayoutParams(new LinearLayout.LayoutParams(Toolbar.LayoutParams.MATCH_PARENT, 0, 0.5f));
        startIntentService();
    }
